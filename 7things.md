# 7 things I wish I had Known Before Migrating a 60Tb DWH from netezza to Azure
...
### This is not Synapse, its ADF and a Dedicated Pool 
  ...
  6.  Backups/restores (who what, why when how, BKP sproc, ext BKP sproc)
	...
	when doing a restore, have been told scale of new target doesn't matter.
	restore to new endpoint and then RENAME to flip them around
  ...
  18. Netezzas hidden columns	
  	https://dwgeek.com/netezza-internal-datatypes-rowid-transactionid-datasliceid.html/
	rowid		rowid			speical unque row ident
	transaction ID	Createxid		rowversion
			deletexid
